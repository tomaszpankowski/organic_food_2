...
class ContactForm extends Component {
    ...
    render() {
        return (
            <Container fluid className={"contact-s2 align-items-center px-0 py-5 border-top border-success d-flex minh-50vh " + this.props.classExt}>
                <Row className="mx-auto text-center w-100">
                    <Col xs={11} md={6} className="mx-auto p-0 d-flex align-items-center">
                        <Form className="text-start w-100 border border-success p-4 rounded bg-light shadow text-success opacity-9 fw-bold"
                            autoComplete="off"
                            method="POST">
                            <div className="border-bottom border-success mb-4">
                            ...
                            <Form.Group controlId="formFirstName">
                                ...
                                <Form.Control type="text"
                                    ...
                                    className="rounded-pill border-success text-secondary"
                                    maxLength="50"
                                    name="firstName"
                            ...
                            <Form.Group controlId="formMessage" className="mt-3">
                                ...
                                <Form.Control as="textarea"
                                    rows={4}
                                    className="text-secondary border-success"
                                    maxLength="250"
                                    name="messageText"
                                    onChange={this.updateFormData.bind(this)} 
