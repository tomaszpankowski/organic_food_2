...
const appCfg = {
    routes:[
        ...
        {navItem:true, exact:true, path:"/food",name:"Food",view:<Food/>},
...
const APP_LINKS = {
    messages: "http://localhost/organic_food_2/public/message.php",
    register: "register.php",
    users: "http://localhost/organic_food_2/public/user.php"
};
